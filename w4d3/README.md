...
- AJAX is the missing link between dynamic content in a page and a backend (or api)
- $.ajax or $.get or $.post
- May be subject to CORS issues (ask your backend to talk to their backend)
- Be careful about hacks! (unescaped characters)
